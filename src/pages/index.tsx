  ...
  return (
    <div className={styles.bg}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.drop} onClick={()=>window.open('https://space.bilibili.com/12387501/channel/collectiondetail?sid=304298')}>
      ...
      <div className={styles.footer}>
        ...
        <Text ><Link to="https://beian.miit.gov.cn/" target="_blank">苏ICP备2022015095号-2</Link></Text>
      </div>
