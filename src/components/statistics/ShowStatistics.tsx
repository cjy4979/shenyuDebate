...
export default class ShowStatistics extends Component<any, any> {
    ...
    render() {
        ...
        //票型
        var win1 = this.state.j1win === null ? [] : this.state.j1win.split('@')
        var win2 = this.state.j2win === null ? [] : this.state.j2win.split('@')
        var win3 = this.state.j3win === null ? [] : this.state.j3win.split('@')
